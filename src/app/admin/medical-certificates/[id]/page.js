...
const MedicalCertificatePage = () => {
  ...
  if (!certificate || Object.keys(certificate).length === 0) return <div className="text-center py-20 text-red-500 font-bold">Certificate not found or failed to load.</div>
