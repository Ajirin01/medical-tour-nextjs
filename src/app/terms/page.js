    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="bg-white shadow-lg rounded-lg p-8 sm:p-10 lg:p-12 w-full max-w-4xl">
        ...
        <section className="text-gray-700 text-base space-y-6">
          ...
          <h2 className="text-2xl font-semibold text-primary-6">1. Definitions</h2>
          ...
          <h2 className="text-2xl font-semibold text-primary-6">2. Acceptance of Terms</h2>
          ...
          <h2 className="text-2xl font-semibold text-primary-6">3. Services</h2>
          ...
          <h2 className="text-2xl font-semibold text-primary-6">4. Use of Services</h2>
          ...
          <h2 className="text-2xl font-semibold text-primary-6">5. User Responsibilities</h2>
