          ...
          <div className="flex items-center order-2 gap-1 grow xl:order-3 xl:justify-end">
            {[...Array(5)].map((_, i) => (
              <svg
                ...
                viewBox="0 0 20 20"
              >
                <path d="M9.049 2.927a.998.998 0 011.902 0l1.144 3.523a1 1 0 00.95.69h3.688c.969 0 1.371 1.24.588 1.81l-2.986 2.17a1 1 0 00-.364 1.118l1.144 3.523c.3.924-.755 1.688-1.538 1.118l-2.986-2.17a1 1 0 00-1.176 0l-2.986 2.17c-.783.57-1.838-.194-1.538-1.118l1.144-3.523a1 1 0 00-.364-1.118l-2.986-2.17c-.783-.57-.38-1.81.588-1.81h3.688a1 1 0 00.95-.69l1.144-3.523z" />
              </svg>
            ))}
          </div>
        </div>
