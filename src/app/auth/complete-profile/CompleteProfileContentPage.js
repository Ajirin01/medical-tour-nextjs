          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                ...
                <input name="address.city" value={formData.address.city} onChange={handleChange} className={inputStyle} placeholder="Lagos" />
              </div>
              <div className="space-y-2">
                <label className="text-sm font-semibold text-gray-700 dark:text-gray-300">State / Province</label>
                <input name="address.state" value={formData.address.state} onChange={handleChange} className={inputStyle} placeholder="Lagos State" />
              </div>
              <div className="space-y-2">
            ...
            <div className="space-y-6 pt-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="col-span-full space-y-2">
                  ...
                  <input name="bankDetails.bankName" value={formData.bankDetails.bankName} onChange={handleChange} className={inputStyle} placeholder="Global Health Bank" />
                </div>
              </div>
            </div>
          )}
